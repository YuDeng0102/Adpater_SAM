...
default_scope = 'mmdet'
custom_imports = dict(imports=['project.USIS_SAM.model'], allow_failed_imports=False)
...
model = dict(
    ...
    adapter=dict(
        ...
        type='UAViTAdapters', adapter_layer=range(1, 13, 2), embed_dim=768
    ),
