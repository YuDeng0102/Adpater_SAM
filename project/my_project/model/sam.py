...
from transformers.models.sam.modeling_sam import SamVisionEncoderOutput, SamPositionalEmbedding, SamMaskDecoder, \
    SamPromptEncoder
from .image_encoder import image_encoder
from peft import get_peft_config, get_peft_model
@MODELS.register_module()
class SamVisionEncoder(BaseModule):
    def __init__(
            self,
            hf_pretrain_name,
            extra_config,
        ...
        vision_encoder = image_encoder(sam_config)
        # load checkpoint
...
@MODELS.register_module()
class PrompterAnchorRoIPromptHead(StandardRoIHead):
    def __init__(
            self,
            with_extra_pe=False,
            *args,
...
@MODELS.register_module()
class PrompterAnchorMaskHead(FCNMaskHead, BaseModule):
    def __init__(
            self,
            mask_decoder,
            in_channels,
