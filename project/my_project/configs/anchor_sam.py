...
default_scope = 'mmdet'
custom_imports = dict(imports=['project.my_project.model'], allow_failed_imports=False)
...
# sam base model
sam_pretrain_name = "pretrain/sam-vit-base"
sam_pretrain_ckpt_path = "pretrain/sam-vit-base/pytorch_model.bin"
...
model = dict(
    ...
    roi_head=dict(
        type='PrompterAnchorRoIPromptHead',
        with_extra_pe=True,
